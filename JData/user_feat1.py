...
def get_actions(start_date=None, end_date=None):
    if start_date==None:
        dump_path = r'F:\cache2\all_action_2016-01-31_2016-04-16.pkl'
        if os.path.exists(dump_path):
            actions = pickle.load(open(dump_path, 'rb+'))
        else:
...
def get_user_tm(start_date,train_end_date):
    dump_path = r'F:\cache2\user_tm_%s_%s.pkl' % (start_date, train_end_date)
    if os.path.exists(dump_path):
...
def get_user_conversion(start_date, end_date):
    ...
    dump_path = r'F:\cache2\user_feat_accumulate_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
...
def get_user_all_action_feat(start_date, end_date, i):
    dump_path = r'F:\cache2\user_all_action_accumulate_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
...
def get_user_type_action(start_date, end_date, i):
    dump_path = r'F:\cache2\user_type_n_action_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        user_type = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_cate8(start_date, end_date)
...
def get_user_last_buy_tm(start_date,end_date):
    dump_path = r'F:\cache2\user_last_buy_tm_%s.pkl' % end_date
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_other(start_date, end_date)
...
def get_basic_product_feat():
    dump_path = r'F:\cache2\basic_product.pkl'
    if os.path.exists(dump_path):
...
def get_comments(end_date):
    dump_path = r'F:\cache2\comments_accumulate_%s.pkl' % (end_date)
    if os.path.exists(dump_path):
...
def get_product_conversion(start_date, end_date):
    ...
    dump_path = r'F:\cache2\product_feat_accumulate_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_cate8(start_date, end_date)
...
def get_brand_feat(start_date, end_date):
    dump_path = r'F:\cache2\brand_feat_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
...
def get_user_brand(start_date, end_date) :
    dump_path = r'F:\cache2\user_brand_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
...
def get_action_feat(start_date, end_date, i):
    dump_path = r'F:\cache2\action_accumulate_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_cate8(start_date, end_date)
...
def get_action_tm(start_date, end_date):
    dump_path = r'F:\cache2\action_tm_%s.pkl' % (end_date)
    if os.path.exists(dump_path):
...
def get_action_rank(start_date, end_date):
    dump_path = r'F:\cache2\action_rank_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
...
def get_active_days(start_date, end_date, i):
    dump_path = r'F:\cache2\action_days_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_cate8(start_date,end_date)
...
def get_active_minutes(start_date, end_date, i):
    dump_path = r'F:\cache2\action_minutes_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pickle.load(open(dump_path, 'rb+'))
    else:
        actions = get_cate8(start_date,end_date)
...
def make_user_train_set(train_end_date, test_start_date, test_end_date):
    dump_path = r'F:\cache2\user_train_set_%s_%s_%s.pkl' % (train_end_date, test_start_date, test_end_date)
