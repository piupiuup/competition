...
data = {
    'tra': pd.read_csv(data_path + 'air_visit_data.csv'),
    'as': pd.read_csv(data_path + 'air_store_info.csv'),
    'hs': pd.read_csv(data_path + 'hpg_store_info.csv'),
    'ar': pd.read_csv(data_path + 'air_reserve.csv'),
    'hr': pd.read_csv(data_path + 'hpg_reserve.csv'),
    'id': pd.read_csv(data_path + 'store_id_relation.csv'),
    'tes': pd.read_csv(data_path + 'sample_submission.csv'),
    'hol': pd.read_csv(data_path + 'date_info.csv').rename(columns={'calendar_date': 'visit_date'})
}
