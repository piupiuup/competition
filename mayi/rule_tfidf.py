...
# shop_cwifi_count = train.groupby(['shop_id','cwifi'],as_index=False)['shop_id'].agg({'shop_cwifi_count':'count'})
# cwifi_count = train.groupby(['cwifi'],as_index=False)['shop_id'].agg({'cwifi_count':'count'})
# shop_cwifi_count = shop_cwifi_count.merge(cwifi_count,on='cwifi')
# shop_cwifi_count['cwifi_pred'] = shop_cwifi_count['shop_cwifi_count']/shop_cwifi_count['cwifi_count']
