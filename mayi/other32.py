...
def make_feat(data):
    ...
    df_train_path = cache_path + 'multi_train_feat2_{}.hdf'.format(mall_id)
    df_test_path = cache_path + 'multi_test_feat2_{}.hdf'.format(mall_id)
    lbl_path = cache_path + 'lbl_{}.hdf'.format(mall_id)
    if os.path.exists(df_train_path) & os.path.exists(df_test_path) & 1:
...
# result.to_hdf(cache_path+'multi_pred_01-12.hdf', 'w', complib='blosc', complevel=5)
