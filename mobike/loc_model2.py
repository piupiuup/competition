...
def get_holiday_hour(data, sample, data_key):
    ...
    if os.path.exists(feat_path) & flag:
        ...
        data_temp = data.copy()
        data_temp['date'] = data_temp['starttime'].str[:10]
...
def make_train_set(data, candidate):
    ...
    if os.path.exists(result_path) & flag:
        ...
        result = concat([sample, start_loc, end_loc, sloc_eloc, ex_sloc, ex_eloc,
                         ...
                         holiday_exhour_ex_sloc_eloc,holiday_eloc,exloc,date_hour_eloc
                         ])
...
predictors = train_feat.columns.drop(['orderid', 'geohashed_end_loc', 'label', 'userid',
 'bikeid', 'starttime', 'geohashed_start_loc','exloc_count','holiday_eloc_count',
 'holiday_exhour_ex_sloc_count', 'holiday_exhour_ex_sloc_eloc_count',
 'holiday_exloc_count','holiday_hour_count','holiday_hour_eloc_count', 'holiday_hour_ex_sloc_count',
 'holiday_hour_ex_sloc_eloc_count', 'holiday_hour_exloc_count', 'holiday_hour_sloc_count',
 'holiday_hour_sloc_eloc_count', 'hour_exloc_count'])
