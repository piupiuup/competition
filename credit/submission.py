...
# test_feat = data[data['SK_ID_CURR'].isin(test['SK_ID_CURR'].values)].copy()
# train_feat = data[data['SK_ID_CURR'].isin(train['SK_ID_CURR'].values)].copy()
#
...
#
# test_feat['TARGET'] = preds
# submission_file_name = r'C:\Users\csw\Desktop\python\credit\submission\sub{}.csv'.format(datetime.datetime.now().strftime('%Y%m%d_%H%M%S'))
# test_feat[['SK_ID_CURR','TARGET']].to_csv(submission_file_name, index=False)



################################## CV ###############################
# Divide in training/validation and test data
test_df = data[data['SK_ID_CURR'].isin(test['SK_ID_CURR'].values)].copy()
train_df = data[data['SK_ID_CURR'].isin(train['SK_ID_CURR'].values)].copy()
