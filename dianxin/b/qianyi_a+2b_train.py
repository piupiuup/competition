...
data_pred.to_csv(r'C:\Users\cui\Desktop\python\dianxin\submission\data_preds_xgb1_a+2b_{}.csv'.format(
...
submission[['user_id','current_service']].to_csv(r'C:\Users\cui\Desktop\python\dianxin\submission\xindai_sumbmission_xgb1_a+2b_{}.csv'.format(
    datetime.datetime.now().strftime('%Y%m%d_%H%M%S')),index=False)