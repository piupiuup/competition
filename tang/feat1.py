...
def make_feat(train,test):
    ...
    data['体检星期'] = (pd.to_datetime(data['体检日期'])).dt.dayofweek
    data['weight'] = data['血糖']
...
predictors = [f for f in test_feat.columns if f not in (['体检日期','血糖','weight'])]
...
# lgb_test = lgb.Dataset(train_feat[predictors], train_feat.血糖)
#
