...
#使用xgb
def predict_4(train,test,coefficient=1,silent=1):
    ...
    xgb1 = XGBClassifier()
    xgb1.fit(train_1[predictors], train_1[target])
    result1 = xgb1.predict_proba(test_1[predictors])
    ...
    xgb2 = XGBClassifier()
    xgb2.fit(train_2[predictors], train_2[target])
    result2 = xgb2.predict_proba(test_2[predictors])
    ...
    xgb3 = XGBClassifier()
    xgb3.fit(train_3[predictors], train_3[target])
    result3 = xgb3.predict_proba(test_3[predictors])
